...
The ER model should look like this where code is the primary key in the region_def table and links to the Region column (foreign key) in the catch table. One region code in the region_def table is assigned to each of many records in the catch table.  
